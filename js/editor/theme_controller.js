...
export function createThemeController(ctx) {
  ...
  function buildThemePack() {
    ...
    return {
      ...
      effects: {
        ...
        nodeAccentBorder: theme.nodeAccentBorder === true,
      },
  ...
  function applyThemePack(rawPack) {
    ...
    if (pack.effects && typeof pack.effects === "object") {
      ...
      if (typeof pack.effects.nodeAccentBorder === "boolean") theme.nodeAccentBorder = pack.effects.nodeAccentBorder;
    }
  ...
  function applyUiTheme() {
    ...
    applyPromptPaletteNodeChrome(node, t, { accentBorder: theme.nodeAccentBorder === true });
    applyFontSettings();
    refreshFontControlsUI();
