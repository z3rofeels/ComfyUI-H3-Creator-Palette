  ...
  root.innerHTML = `
    <div class="wg-toolbar" data-el="toolbar">
      <div class="wg-toolbar-group left" data-el="toolbarMajor" aria-label="Prompt tools">
        <button class="wg-icon-btn wg-library-launch" data-act="picker" data-el="btnGallery" title="Prompt Library — Starter Packs and My Library" aria-label="Open Prompt Library" aria-expanded="false">${svgIcon("gallery")}<span class="wg-library-launch-label">Library</span></button>
